...
def arguments_parser():
    ...
    parser = argparse.ArgumentParser(prog='content.py', 
    ...
    scan_p.add_argument("-i",
                        "--inputfilepath",
                        help="input fastq/fastq.gz file path",
                        type=str,
                        required=True)
    scan_p.add_argument("-o",
                        "--outputdirpath",
    ...
    cov_p.add_argument("-input",
                        help="""Input directory/file path. If the path point to 
                        a directory, all the '.content' files will be analysed 
                        (individually and together).""",
                        type=str,
                        required=True)
    cov_p.add_argument("-outdir",
                        help="""Output directory path. Nb: if the ouput 
                        directory does not exist, it will be created along with
                        its parent directories. If only a directory name is 
                        ...
                        type=str,
                        required=True)
    cov_p.add_argument("-prefix",
                        help="""Prefix used to name output files but also as  
                        plots' title (for global analysis). Spaces will be 
                        replaced with '_' in the files names""",
                        type=str,
                        required=True)
    cov_p.add_argument("-genomesize",
                        help="""genome size (bp). Necessary to compute genome
                        coverage""",
                        type=int,
                        required=True)
    
    cov_p.add_argument("-n",
    ...
    cov_p.add_argument("-m",
                        ...
                        type=int,
                        default=100)  
    cov_p.add_argument("-mincoverage",
...
#                         type=str,
#                         required=True)
#     parser.add_argument("-genomesize",
#                         help="""genome size (bp). Necessary to compute genome
#                         coverage""",
#                         type=int,
#                         required=True)
